...
/**
 *
 * source code adapted from  @author Andrew Guillory gtg008g@mail.gatech.edu
 * @version 1.0
 */
    ...
    public static void main(String[] args) {
        ...
        for (int iter : iters) {
            ...
            for (int j = 0; j < testRuns; j++) {
                ...
                start = System.nanoTime();
                SimulatedAnnealing sa = new SimulatedAnnealing(1E11, .65, hcp);
        ...
        for (int i = 0; i < coolings.length; i++){
            ...
            System.out.println("fitness average is " + average_sa + ", time average is " + averagetime_sa);
            String final_result = "";
            final_result =
                    "fitness" + "," + Double.toString(coolings[i]) + "," + Integer.toString(average_sa) + "," + Double.toString(averagetime_sa);
