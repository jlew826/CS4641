    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
          ...
          for(int k = 0; k < population.length; k++) {
              ...
              oa[0] = new StandardGeneticAlgorithm(population[k], mate[k], mute[k], nnop[0]);
              ...
              final_result = oaNames[0] + "," + "iterations" + "," + trainingIterations + "," + "population" + "," + population[k] + "," + "mate" + "," + mate[k] + "," + "mute" + ","
                        + mute[k] + "," + "training accuracy" + "," + df.format(correct / (correct + incorrect) * 100)
                        + "," + "training time" + "," + df.format(trainingTime) + "," + "testing time" +
                        "," + df.format(testingTime);
              write_output_to_file("Optimization_Results", "abalone_GA.txt", final_result, true);
        }
